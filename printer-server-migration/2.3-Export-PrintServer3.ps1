# ==================================================================
# Phase 2: XML-Export der Drucker von <PRINT-SERVER-3>
...
# Konfiguration
$SourceServer = "<PRINT-SERVER-3>"
$OutputDir = $PSScriptRoot
$OutputFilePrinters = Join-Path $OutputDir "2.3-Export-<PRINT-SERVER-3>-Printers.xml"
$OutputFilePorts = Join-Path $OutputDir "2.3-Export-<PRINT-SERVER-3>-Ports.xml"
$LogFile = "$OutputDir\Logs\2.3-Export-<PRINT-SERVER-3>_$(Get-Date -Format 'yyyy-MM-dd_HHmmss').log"
...
Write-Log "=== Export <PRINT-SERVER-3> gestartet ===" "INFO"
...
Write-Log "=== Export <PRINT-SERVER-3> abgeschlossen ===" "INFO"
