# ==================================================================
# Phase 2: XML-Export der Drucker von <PRINT-SERVER-1>
...
# Konfiguration
$SourceServer = "<PRINT-SERVER-1>"
$OutputDir = $PSScriptRoot
$OutputFilePrinters = Join-Path $OutputDir "2.1-Export-<PRINT-SERVER-1>-Printers.xml"
$OutputFilePorts = Join-Path $OutputDir "2.1-Export-<PRINT-SERVER-1>-Ports.xml"
$LogFile = "$OutputDir\Logs\2.1-Export-<PRINT-SERVER-1>_$(Get-Date -Format 'yyyy-MM-dd_HHmmss').log"
...
Write-Log "=== Export <PRINT-SERVER-1> gestartet ===" "INFO"
...
Write-Log "=== Export <PRINT-SERVER-1> abgeschlossen ===" "INFO"
