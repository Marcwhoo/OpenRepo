...
# HKCU AlwaysInstallElevated nochmal sicherheitshalber l�schen
...
# Registry vollst�ndig bereinigen - sowohl MSI als auch Click-to-Run Pfade
$regPaths = @(
...
# DisabledItem-Eintr�ge explizit entfernen
